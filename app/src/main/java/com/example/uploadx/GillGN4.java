...
public class GillGN4 extends AppCompatActivity {
    public TextView tpi;
    public TextView s_d;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gill_g_n4);
        ...
        new GillGN4.GetDataTaskgv20().execute();
    ...
    class GetDataTaskgv20 extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            dialog = new ProgressDialog(GillGN4.this);
        ...
        protected Void doInBackground(Void... params) {
             ...
             */
            JSONObject jsonObject = JSONPArsergillgn4.getDataFromWeb();
            try {
                /**
...
//                            list.add(model);
                ...
                Log.i(JSONPArsergillgn4.TAG, "" + je.getLocalizedMessage());
