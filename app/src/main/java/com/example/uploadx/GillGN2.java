...
public class GillGN2 extends AppCompatActivity {
    public TextView tpi;
    public TextView s_d;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gill_g_n2);
        ...
        del_speed=(TextView)findViewById(R.id.del_speed);
        ...
        new GillGN2.GetDataTaskgv20().execute();
    }
    class GetDataTaskgv20 extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            dialog = new ProgressDialog(GillGN2.this);
        ...
        protected Void doInBackground(Void... params) {
             ...
             */
            JSONObject jsonObject = JSONPArsergillgn2.getDataFromWeb();
            try {
                /**
                    ...
                    if(jsonObject.length() > 0) {
                        ...
                        if(lenArray > 0) {
                            ...
                            for( ; jIndex < lenArray; jIndex++) {
                                ...
                                String DEL_SPEED_OLD=innerObject.getString("Delivery_Speed");
                                ...
                                {   composition.setText(COMPOSITION);
                                    ...
                                    del_speed.setText(DEL_SPEED_OLD);
                                    ratch.setText(RATCH);
...
//                            list.add(model);
                ...
                Log.i(JSONPArsergillgn2.TAG, "" + je.getLocalizedMessage());
