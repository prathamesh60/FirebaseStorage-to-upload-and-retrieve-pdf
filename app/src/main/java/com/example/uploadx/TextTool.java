...
public class TextTool extends AppCompatActivity {
    public TextView tpi;
    public TextView s_d;
    ...
    class GetDataTaskgv20 extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            dialog = new ProgressDialog(TextTool.this);
        ...
        protected Void doInBackground(Void... params) {
             ...
             */
            JSONObject jsonObject = JSONPArsertextool.getDataFromWeb();
            try {
                /**
                    ...
                    if(jsonObject.length() > 0) {
                        ...
                        if(lenArray > 0) {
                            ...
                            for( ; jIndex < lenArray; jIndex++) {
                                ...
                                String SPEED=innerObject.getString("Speed_RPM");
                                ...
                                String RING_TRAVELLER =innerObject.getString("Ring_Traveller");
                                String TOP_ARM_PRESSURE=innerObject.getString("Top_Arm_Pressure");
                                String RATCHET_WHEEL=innerObject.getString("Ratchet_Wheel");
                                ...
                                {   composition.setText(COMPOSITION);
                                    ...
                                    ratchet_wheel.setText(RATCHET_WHEEL);
                                    //composition.setText(COMPOSITION);
                                    break;
                                }
...
//                            list.add(model);
                ...
                Log.i(JSONPArsertextool.TAG, "" + je.getLocalizedMessage());
