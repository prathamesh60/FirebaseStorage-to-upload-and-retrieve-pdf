...
public class GillGN1 extends AppCompatActivity {
    public TextView tpi;
    public TextView s_d;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gill_g_n1);
        ...
        new GillGN1.GetDataTaskgv20().execute();
    }
    class GetDataTaskgv20 extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            dialog = new ProgressDialog(GillGN1.this);
        ...
        protected Void doInBackground(Void... params) {
             ...
             */
            JSONObject jsonObject = JSONPArsergillgn1.getDataFromWeb();
            try {
                /**
...
//                            list.add(model);
                ...
                Log.i(JSONPArsergillgn1.TAG, "" + je.getLocalizedMessage());
