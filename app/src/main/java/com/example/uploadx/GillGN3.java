...
public class GillGN3 extends AppCompatActivity {
    public TextView tpi;
    public TextView s_d;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gill_g_n3);
        ...
        new GillGN3.GetDataTaskgv20().execute();
    ...
    class GetDataTaskgv20 extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            dialog = new ProgressDialog(GillGN3.this);
        ...
        protected Void doInBackground(Void... params) {
             ...
             */
            JSONObject jsonObject = JSONPArsergillgn3.getDataFromWeb();
            try {
                /**
...
//                            list.add(model);
                ...
                Log.i(JSONPArsergillgn3.TAG, "" + je.getLocalizedMessage());
