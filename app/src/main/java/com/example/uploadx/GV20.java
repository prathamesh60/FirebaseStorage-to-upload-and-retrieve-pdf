...
public class GV20 extends AppCompatActivity {
    public TextView tpi;
    public TextView s_d;
    ...
    public TextView feed_guide_setting;
    public TextView faller_pins;
    public TextView faller_guide_setting;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g_v20);
    ...
    class GetDataTaskgv20 extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            dialog = new ProgressDialog(GV20.this);
        ...
        protected Void doInBackground(Void... params) {
             ...
             */
            JSONObject jsonObject = JSONPArsergv20.getDataFromWeb();
            try {
                /**
                    ...
                    if(jsonObject.length() > 0) {
                        ...
                        if(lenArray > 0) {
                            ...
                            for( ; jIndex < lenArray; jIndex++) {
                                ...
                                String FEED_WRPG=innerObject.getString("Feed_Wrapping");
                                ...
                                String RATCH=innerObject.getString("Feed_Guide_Setting");
                                String FALLER_PINS=innerObject.getString("Fallers_Pins(flat)");
                                String FR_PRESSURE=innerObject.getString("Faller_Guide_Setting");
                                ...
                                if(count.equals(coun) && blend.equals(bend))
                                {
                                    ...
                                    feed_guide_setting.setText(RATCH);
                                    faller_pins.setText(FALLER_PINS);
                                    faller_guide_setting.setText(FR_PRESSURE);
...
//                            list.add(model);
                ...
                Log.i(JSONPArsergv20.TAG, "" + je.getLocalizedMessage());
