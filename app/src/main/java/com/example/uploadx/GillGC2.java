...
public class GillGC2 extends AppCompatActivity {
    public TextView tpi;
    public TextView s_d;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new GillGC2.GetDataTaskgv20().execute();
    }
    class GetDataTaskgv20 extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            dialog = new ProgressDialog(GillGC2.this);
        ...
        protected Void doInBackground(Void... params) {
             ...
             */
            JSONObject jsonObject = JSONPArsergillgc2.getDataFromWeb();
            try {
                /**
...
//                            list.add(model);
                ...
                Log.i(JSONPArsergillgc2.TAG, "" + je.getLocalizedMessage());
