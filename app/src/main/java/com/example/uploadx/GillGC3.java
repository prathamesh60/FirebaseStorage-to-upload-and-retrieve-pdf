...
public class GillGC3 extends AppCompatActivity {
    public TextView tpi;
    public TextView s_d;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new GillGC3.GetDataTaskgv20().execute();
    }
    class GetDataTaskgv20 extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            dialog = new ProgressDialog(GillGC3.this);
        ...
        protected Void doInBackground(Void... params) {
             ...
             */
            JSONObject jsonObject = JSONPArsergillgc3.getDataFromWeb();
            try {
                /**
...
//                            list.add(model);
                ...
                Log.i(JSONPArsergillgc3.TAG, "" + je.getLocalizedMessage());
