...
public class GillGC4 extends AppCompatActivity {
    public TextView tpi;
    public TextView s_d;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gill_g_c4);
        setContentView(R.layout.activity_gill_g_c3);
        setContentView(R.layout.activity_gill_g_c2);
        ...
        new GillGC4.GetDataTaskgv20().execute();
    }
    class GetDataTaskgv20 extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            dialog = new ProgressDialog(GillGC4.this);
        ...
        protected Void doInBackground(Void... params) {
             ...
             */
            JSONObject jsonObject = JSONPArsergillgc4.getDataFromWeb();
            try {
                /**
                    ...
                    if(jsonObject.length() > 0) {
                        ...
                        if(lenArray > 0) {
                            ...
                            for( ; jIndex < lenArray; jIndex++) {
                                ...
                                String FR_PRESSURE=innerObject.getString("FR_Presuure");
...
//                            list.add(model);
                ...
                Log.i(JSONPArsergillgc4.TAG, "" + je.getLocalizedMessage());
